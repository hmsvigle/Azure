...
### IP Addressing:
  ...
  * **NSG:** NSG can be `attached at Subnet/NIC layer.` 
    * create NSG (select vnet) --> go to subnets --> Associate with Vnet & subnet --> Inbound/Outbound Security Rules --> Add rule for traffic.
    ...
    <img src="https://user-images.githubusercontent.com/24938159/122937379-8def8200-d38f-11eb-9710-abac4e5cc0be.png" width="600">  <img src="https://user-images.githubusercontent.com/24938159/122937556-b37c8b80-d38f-11eb-87db-ef0911d0f39c.png" width="600">
