...
* A **`Budget`** can be created in `Cost Management and Billing` to set Thresholds for Costs consumed. You can then be notified via **alerts**.
...
* Create Eventhub onto the Region of RG -> Select Tier (Basic). EventHub is a data ingestion tool
  ...
  * In `Stream Analytics Job` --> Select Inputs --> 
  ...
  <img src="https://user-images.githubusercontent.com/24938159/123532831-4752ac80-d72e-11eb-8d1d-2de462905bba.png" width="600">
