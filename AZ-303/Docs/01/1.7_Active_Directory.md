...
* Risk `Detection` & `Risk Remediation`: 

  <img src="https://user-images.githubusercontent.com/24938159/123746899-dd720880-d8cf-11eb-8011-a72c498e053d.png" width="400">


### 1.7.2.2 Identoity Governance:
...
* Based on the reviw policy set, reviewer will be notified to take action.
  ...
  <img src="https://user-images.githubusercontent.com/24938159/123746313-18277100-d8cf-11eb-902c-214fedad5c07.png" width="500">
...
> Notes:
* **Azure Active Directory Domain Services because it does not support schema extensions.**
